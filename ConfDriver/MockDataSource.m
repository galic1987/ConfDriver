...
+ (NSMutableArray*)fakeNames {
  ...
  nil];*/
    ...
    return [NSMutableArray arrayWithObjects:
                  [StandardTableItemCell itemWithTitle:@"First" subtitle:@"Hello #1!"],
                  [StandardTableItemCell itemWithTitle:@"Second" subtitle:@"Hello #2!"],
                  [StandardTableItemCell itemWithTitle:@"Third" subtitle:@"Hello #3!"],
                  [StandardTableItemCell itemWithTitle:@"Fourth" subtitle:@"Hello #4!"],
                  [StandardTableItemCell itemWithTitle:@"Fifth" subtitle:@"Hello #5!"],
                  nil];
}
